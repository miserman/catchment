...
(access <- catchment_ratio(consumers, providers, weight = weight, normalize_weight = TRUE))
```
...
(access_propnorm <- catchment_ratio(consumers, providers, weight = weight / rowSums(weight)))

# compare with originals
access_propnorm - access
```
...
(access_insurance <- catchment_ratio(
  consumers, providers, weight = weight * insurance_weight, normalize_weight = TRUE
))
...
(access_monetary <- catchment_ratio(
  consumers, providers, weight = weight * monetary_cost, normalize_weight = TRUE
))
